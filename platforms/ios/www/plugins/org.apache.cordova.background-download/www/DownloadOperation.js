...
DownloadOperation.prototype.startAsync = function() {
    ...
    var deferral = new Promise.Deferral(),
        ...
        console.log('exec');
    cordovaRef.exec(successCallback, errorCallback, "BackgroundDownload", "startAsync", [this.uri, this.resultFile.fullPath]);
...
DownloadOperation.prototype.stop = function() {
    console.log('stop');
    // TODO return promise
    cordovaRef.exec(null, null, "BackgroundDownload", "stop", [this.uri]);
